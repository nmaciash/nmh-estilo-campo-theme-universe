<?php
/*
*  Template Name: Página Carta-Sugerencias
*/ 
		...
		<div class="container__menu__body">
			<div class="row header__menus">
				<div class="col-12 col__header__menus">
					<h1 class="title">MENÚS Y SUGERENCIAS</h1>
				</div>
			</div>
            ...
            <?php
                $url_carta_es = get_field('carta_es');
                $url_carta_en = get_field('carta_en');
                $url_infantil_es = get_field('infantil_es');
                $url_infantil_en = get_field('infantil_en');
                $url_almuerzo_dia_es_en = get_field('almuerzo_dia');
                $url_carta_vinos_es_en = get_field('carta_vino_es_en');
            ?>
			...
			<div class="row links__menu">
					...
					<div class="buttons__menu">
						...
						<div class="row">
							<div class="col-6 col__flag__img d-flex justify-content-end">
                                ...
                                <?php
                                    if ($url_almuerzo_dia_es_en):
                                ?>    
								<a href="<?php echo esc_url($url_almuerzo_dia_es_en); ?>" target="_blank" class="btn btn__flag" role="button">	
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/es.png" alt="" class="img__flag">
								</a>                        
							</div>
							<div class="col-6 col__flag__img d-flex justify-content-start">                                
						...
						<div class="row">
							<div class="col-6 col__flag__img d-flex justify-content-end">
                                ...
                                <?php
                                    if ($url_carta_es):
                                ?> 
								<a href="<?php echo esc_url($url_carta_es); ?>" target="_blank" class="btn btn__flag" role="button">	
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/es.png" alt="" class="img__flag">
								</a>   
                                <?php endif; ?>                     
							</div>
							<div class="col-6 col__flag__img d-flex justify-content-start">
							    <?php
                                    if ($url_carta_en):
                                ?> 	
                                <a href="<?php echo esc_url($url_carta_en); ?>" target="_blank" class="btn btn__flag" role="button">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/uk.png" alt="" class="img__flag">
								</a>   
                                <?php endif; ?>
							</div>
				...
				<div class="col-md-6 hide">
				    <a href="https://estilocampo.net/opciones-menus/">
					<div class="buttons__menu">
						
							<h3>PROMOCIONES DE MENÚ</h3>
							<div class="row">
								<div class="col-12 col__flag__img d-flex justify-content-end">
									<a href="<?php echo esc_url($url_menu_dia_es); ?>" target="_blank" class="btn btn__flag" role="button">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/wt.png" alt="" class="img__flag">
									</a>                        
								</div>
						...
						<div class="row">
							<div class="col-6 col__flag__img d-flex justify-content-end">
                                <?php
                                    if ($url_infantil_es):
                                ?> 
								<a href="<?php echo esc_url($url_infantil_es); ?>" target="_blank" class="btn btn__flag" role="button">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/es.png" alt="" class="img__flag">
								</a>   
                                <?php endif; ?>                     
							</div>
							<div class="col-6 col__flag__img d-flex justify-content-start">
                                <?php
                                    if ($url_infantil_en):
                                ?> 
								<a href="<?php echo esc_url($url_infantil_en); ?>" target="_blank" class="btn btn__flag" role="button">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/uk.png" alt="" class="img__flag">
								</a>  
                                <?php endif; ?> 
							</div>
						...
						<a href="">
							...
							<div class="row">
								<div class="col-6 col__flag__img d-flex justify-content-end">
									<!-- <a href="" target="_blank" class="btn btn__flag" role="button"> -->
                                    <?php
                                        if ($url_carta_vinos_es_en):
                                    ?> 
									<a href="<?php echo esc_url($url_carta_vinos_es_en); ?>" target="_blank" class="btn btn__flag" role="button">	
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/es.png" alt="" class="img__flag">
									</a>                        
								</div>
								<div class="col-6 col__flag__img d-flex justify-content-start">
